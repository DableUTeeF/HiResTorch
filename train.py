...
if __name__ == '__main__':
    ...
    trainset = CIFAR10(root='/home/palmy/PycharmProjects/DATA/cifar10', train=True, download=True, transform=transform_train)
    trainloader = torch.utils.data.DataLoader(trainset, batch_size=128, shuffle=True, num_workers=2)

    testset = CIFAR10(root='/home/palmy/PycharmProjects/DATA/cifar10', train=False, download=True, transform=transform_test)
